    ...
    var body: some View {
        ...
        ScrollView(.vertical, showsIndicators: false) {
            ...
            Group {
                ...
                ReferenceImageItem(image: "loading", madeFrom: "Photo made by Ekaterina Burtseva on 123RF", link: "https://www.123rf.com/photo_100984944_stock-vector-summer-loading-please-wait.html")

                ReferenceImageItem(image: "loading1", madeFrom: "Photo made by Bobnevv on VectorStock", link: "https://www.vectorstock.com/royalty-free-vector/status-bar-icon-isolated-vector-9546210")
            }
        }
        .padding()
